...
INSERT INTO recipes (Price, Name, ImageFull, Thumbnail, Description, Servings, Calories, Fat, Carbs, Protein)
VALUES(13.27, 'Greek Salad with Za’atar Eggplant and Marinated “Feta”', 'https://s3-us-west-2.amazonaws.com/purplecarrot/greek-salad-full.jpg', 'https://s3-us-west-2.amazonaws.com/purplecarrot/greek-salad-thumbnail.jpg', 'Almond-based “feta” is the highlight of this meal with bright lemon zest, fresh thyme leaves, and olive oil that bring it all together. The salad itself is more of a hearty vegetable bowl with crunchy peppers, briny olives, and protein packed walnuts over a bed of romaine. If you have a grill, the eggplant can be sliced into ½ inch thick planks and drizzled with olive oil and sprinkled with salt and pepper before getting grilled on high heat.', 2, 490, 44, 24, 9);
INSERT INTO recipes (Price, Name, ImageFull, Thumbnail, Description, Servings, Calories, Fat, Carbs, Protein)
VALUES(13.27, 'Creamy Mac n’ Cheese with Green Chiles and Garlic Broccoli', 'https://s3-us-west-2.amazonaws.com/purplecarrot/mac-cheese-full.jpg', 'https://s3-us-west-2.amazonaws.com/purplecarrot/mac-cheese-thumbnail.jpg', 'Creamy and decadent, no one will believe this mac n’ cheese has a plant-based sauce! This family friendly meal can be made with or without the green chiles, which are generally on the milder side and packed with flavor. Buttery breadcrumbs coat the top and be sure to watch these closely in the oven, it should only take a few minutes. The garlic broccoli is a head nod to a childhood favorite, and is cooked last minute and served bright green.', 2, 880, 27, 129, 40);
